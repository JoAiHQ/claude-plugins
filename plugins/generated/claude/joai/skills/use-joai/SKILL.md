...
- `joai-contact-activity-delete` (collect) — Remove a single activity (note, call, meeting, email, task, or custom event) from a contact's timeline — useful for cleaning up duplicates or obsolete entries.
...
- ...and 69 more actions exposed by the hosted MCP app server.
